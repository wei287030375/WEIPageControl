...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        pageControl3 = WEIPageControl()
        pageControl3.frame = CGRect.init(x: left, y: scrollView3.frame.maxY, width: width, height: 40)
        pageControl3.numberOfPages = pageCount
        pageControl3.currentImage = UIImage.init(named: "Ktv_ic_share_weixin")!
        pageControl3.otherImage = UIImage.init(named: "Ktv_ic_share_qq")!
        pageControl3.pointSize = CGSize.init(width: 25, height: 25)
        pageControl3.clickPoint { (index) in
